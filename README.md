...
- :briefcase: &nbsp; No <a href="https://www2.eb.mil.br/web/guest" target="_blank">Exercito Brasileiro</a>, atuei como <code>Aluno - Aspirante A Oficial</code> tem <br />como missão formar o Aspirante-a-oficial da reserva 2ª classe, habilitando-o<br /> a ingressar no Corpo de Oficiais do Exército Brasileiro, bem como prepará-lo para o serviço ativo como oficial temporário.<br />
